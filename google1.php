...
<div class="Titlestrip">
	<center>
		<p><img src="./Welcome to SVEC   Sri Vasavi Engineering College.staff_files/index_02.gif">
		    <img src="./Welcome to SVEC   Sri Vasavi Engineering College.staff_files/index_03.gif">	  </p>
		<p>&nbsp;    </p>
	</center>
</div>
		...
		<table id="topbar">
			<tr>
				...
				<td height="43" class="box2d selected" onClick="location.href = 'http://www.google.com/webhp?hl=en&tab=ww';"><span>Search</span></td>
				<td class="box2d" href = home.php><span>Images</span></td>
				<td class="box2d" onClick="location.href = 'http://maps.google.com/maps?hl=en&tab=wl';"><span></span></td>
				<td class="box2d" onClick="location.href = 'https://play.google.com/?hl=en&tab=w8';"><span></span></td>
				
				<td class="box2d" onClick="location.href = 'http://news.google.com/nwshp?hl=en&tab=wn';"><span></span></td>
				
				
				<td class="box2d" onClick="location.href = 'https://www.google.com/calendar?tab=wc';"><span></span></td>
				...
				<td class="box2d empty" style="width:5%"><span>&nbsp;</span></td>
				<td class="box2d empty" style="width:10%"><span>Forget Password</span></td>
				<td class="box2d empty" style="width:20%"><span>&nbsp;</span></td>
				<td class="box2d empty" style="width:20%"><span>&nbsp;</span></td>
				<td class="box2d empty" style="width:10%"><span>&nbsp;</span></td>
				<td class="box2d empty" style="width:5%"><span>&nbsp;</span></td>
	...
	<span style="position:absolute; top:93px; right:883px; height: 36px;" align="left">
	<a href="home.php">
	...
	<span style="position:absolute; top:77px; right:43px; height: 36px;" align="right">
	<a href="reg2.php">
	<button id="btnG" class="box2d" style="color:#fff;font-size:11px;font-weight:bold;padding: 0 16px;border:1px solid transparent;background-color:#d14836;text-transform: uppercase;">Rigister</button>
	</a></span>

		<div id="content">
		
			<input id="q" value="" title="Search" autocomplete="" type="text" maxlength="2048" class="box2d" placeholder="Username" background= "#333";>
			<input id="q" value=""  autocomplete="off" type="password" maxlength="2048" class="box3d" placeholder="Password">
			
			<br />
			<img src="img v.jpg" width="443" height="263" class="box2d"><br />
