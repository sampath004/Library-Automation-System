...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<body style="position: static;">
				...
				<table id="bottombar">
			<tbody><tr>
				<td style="position: absolute; left: 0.801017px; bottom: 5.11063px; width: 51px; -moz-transform: rotate(1.69557deg);" class="box2d" >&nbsp;</td>
				<td style="position: absolute; left: 51.6338px; bottom: 11.1701px; width: 65px; -moz-transform: rotate(1.73308deg);" class="box2d selected" >&nbsp;</td>
				<td style="position: absolute; left: 116.199px; bottom: 9.21439px; width: 66px; -moz-transform: rotate(1.679deg);" class="box2d" onClick="location.href = 'test1.php';"><span>Images</span></td>
				<td style="position: absolute; left: 182.543px; bottom: 13.9156px; width: 53px; -moz-transform: rotate(1.53966deg);" class="box2d" >&nbsp;</td>
				<td style="position: absolute; left: 235.132px; bottom: 12.2642px; width: 48px; -moz-transform: rotate(1.01614deg);" class="box2d" >&nbsp;</td>
				<td style="position: absolute; left: 283.083px; bottom: 12.5957px; width: 74px; -moz-transform: rotate(0.773937deg);" class="box2d" ><span></span></td>
				<td style="position: absolute; left: 357.016px; bottom: 13.0941px; width: 154px; -moz-transform: rotate(0.399865deg);" class="box2d" onClick="location.href = 'About.php';"> <div align="center">About Library </div></td>
				<td style="position: absolute; left: 410.933px; bottom: 13.0013px; width: 58px; -moz-transform: rotate(0.0742555deg);" class="box2d" >&nbsp;</td>
				<td style="position: absolute; left: 469.313px; bottom: 13.1988px; width: 53px; -moz-transform: rotate(-0.106409deg);" class="box2d" >&nbsp;</td>
				<td style="position: absolute; left: 521.717px; bottom: 13.1133px; width: 78px; -moz-transform: rotate(-0.354609deg);" class="box2d" onClick="location.href = 'staff.php';">Staff</td>
				<td style="position: absolute; left: 599.712px; bottom: 13.3509px; width: 152px; -moz-transform: rotate(-0.452047deg);" class="box2d" onClick="location.href = 'contact.php';">Contact Information</td>
				<td class="box2d empty" style="width: 82px; position: absolute; left: 651.725px; bottom: 10.7337px; -moz-transform: rotate(-0.641465deg);">&nbsp;</td>
				<td class="box2d empty" style="width: 152px; position: absolute; left: 733.711px; bottom: 9.14521px; -moz-transform: rotate(-0.673916deg);">&nbsp;</td>
				<td class="box2d empty" style="width: 152px; position: absolute; left: 885.733px; bottom: 7.06266px; -moz-transform: rotate(-0.845874deg);"><span>&nbsp;<a href="test.php" class="style1">Forget Password?? </a></span></td>
				<td class="box2d empty" style="width: 182px; position: absolute; left: 1037.76px; bottom: 8.05285px; -moz-transform: rotate(-0.876858deg);">&nbsp;</td>
				<td class="box2d empty" style="width: 147px; position: absolute; left: 1120.29px; bottom: 10.5287px; -moz-transform: rotate(-0.921652deg);">&nbsp;</td>
				<td class="box2d empty" style="width: 47px; position: absolute; left: 1167.26px; bottom: 9.10499px; -moz-transform: rotate(-0.959954deg);"><span>&nbsp;</span></td>
				<td class="box2d empty" style="width: 152px; position: absolute; left: 1213.71px; bottom: 9.36009px; -moz-transform: rotate(-1.22435deg);"><span>&nbsp;</span></td>
			</tr>
		</tbody></table>
		        ...
		        <div class="Titlestrip">
                  <center>
                    <p><span style="position:absolute; top:93px; right:883px; height: 36px;" align="left"> <a href="home.php">

		<form name="myform" onSubmit="return checkForm(this)" method="post">
                    <button id="btnG" class="box2d" style="color:#fff;font-size:11px;font-weight:bold;padding: 0 16px;border:1px solid transparent;background-color:#d14836;text-transform: uppercase;">Login</button>
                    </a></span><img src="./Welcome to SVEC   Sri Vasavi Engineering College.staff_files/index_02.gif"> <img src="./Welcome to SVEC   Sri Vasavi Engineering College.staff_files/index_03.gif"> <span style="position:absolute; top:77px; right:43px; height: 36px;" align="right"> <a href="reg2.php">
                    <button id="btnG" class="box2d" style="color:#fff;font-size:11px;font-weight:bold;padding: 0 16px;border:1px solid transparent;background-color:#d14836;text-transform: uppercase;">Register</button>
                    </a></span></p>
                    <p>&nbsp; </p>
                  </center>
    </div>
                <div id="content"><br>
			<input style="position: absolute; left: 429.635px; top: 255.979px; width: 580px; -moz-transform: rotate(1.37851deg);"maxlength="2048" class="box2d" type="text" placeholder="Username" name="username">
			<img src="img v.jpg" alt="error" width="443" height="263" class="box2d"><br>
	
<input style="position: absolute; left: 429.635px; top: 255.979px; width: 580px; -moz-transform: rotate(1.37851deg);" id="q" title="Search" autocomplete="off" maxlength="2048" class="box3d" type="password" placeholder="Password" name="pwd1"></div>
...
<script type="text/javascript">
  ...
  function checkForm(form)
  {
    ...
    return true;
		...
		<script src="Google%20Space_files/api" type="text/javascript"></script><script src="Google%20Space_files/defaulten.js" type="text/javascript"></script>
		<script>
